...
Exemplos de sistemas centralizados de controle de versão incluem o Subversion (SVN) e o Microsoft Team Foundation Version Control (TFVC). Embora esses sistemas tenham sido amplamente utilizados, muitas equipes hoje migram para sistemas distribuídos, como o Git, principalmente por oferecerem mais flexibilidade, melhor suporte ao trabalho offline e formas mais eficientes de colaboração.

***

A seguir, vamos ter uma visão geral de como funcionam os sistemas distribuídos, quais problemas eles vieram resolver e, de forma introdutória, o que muda em relação ao modelo centralizado.
