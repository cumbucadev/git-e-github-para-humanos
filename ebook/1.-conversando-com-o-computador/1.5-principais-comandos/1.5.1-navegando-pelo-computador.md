...
1. **Caminho absoluto**: mostra o caminho **desde o início da árvore** (raiz).
...
* `C:` é a raiz, que funciona como o ponto inicial daquela árvore de arquivos.
* Dentro de `C:` existe a pasta `Users`.
