# 15.4.3.2 Editando README.md

Chegamos no momento de fazer as alterações no arquivo README.md da cópia local do repositório segundo requisitos da issue criada na seção[8.2-criando-uma-issue-no-github.md](../../../14-issues-no-github/8.2-criando-uma-issue-no-github.md "mention").
