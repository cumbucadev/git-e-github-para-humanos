...
A revisão da conta **camilamaia** foi concluída. Podemos verificar isso tanto na página [5.8.2-pagina-de-notificacoes-notifications.md](../../../9-prazer-github/5.8-explorando-a-interface-do-github/5.8.2-pagina-de-notificacoes-notifications.md "mention"), clicando no notificação nova.
