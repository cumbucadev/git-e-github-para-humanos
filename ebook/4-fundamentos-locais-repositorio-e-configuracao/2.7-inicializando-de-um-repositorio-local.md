...
Nesta seção, vamos aprender como iniciar um novo repositório Git na sua máquina utilizando o comando <mark style="color:purple;">git</mark> <mark style="color:orange;">init</mark>. Essa é a etapa fundamental para começar a versionar um projeto com o Git.
