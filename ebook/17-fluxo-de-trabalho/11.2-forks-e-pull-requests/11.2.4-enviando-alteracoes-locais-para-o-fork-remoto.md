# 17.3.4 Enviando Alterações Locais para o Fork Remoto

Até o momento, nenhuma alteração foi enviada ao fork no GitHub. Seguiremos um processo semelhante ao da seção [9.3.4-enviando-alteracoes-para-o-repositorio-remoto.md](../../15-git-remoto/9.3-interagindo-com-o-repositorio-remoto-hello-world/9.3.4-enviando-alteracoes-para-o-repositorio-remoto.md "mention") para enviá-las.
